...
<body>
  ...
  <header>
    <a href="vaccination center.php" class="logo">
      ...
      <form class="header" action="center view users.php" method="post">
          <ul class="nav">
              <input class="search-box" name="reservation_number"  type="search" placeholder="search with reservation number.....">
          </ul>
...
<div class="table-container">
  <h1 class="heading">Confirm Dose</h1>
  <table class="table">
      <thead>
          <tr>
            <th>name</th>
