...
class User{
    ...
    public static function reservation($vaccination_center_id, $vaccine, $dose_date, $user_id,$first_or_second,$reservation_number_db){
      
      if($first_or_second === 1 and $reservation_number_db ===Null)//m3rf4 httb3t Null wla "Null"
      {
...
//echo User::reservation(1,"AstraZeneca","2022-12-16",8,2,Null);
?>